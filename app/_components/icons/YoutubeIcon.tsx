...
export const YoutubeIcon = (props: ComponentPropsWithRef<"svg"> & {size?: number}) => {
    return (
        <svg 
        width={props.size}
        height={props.size} 
        ...
        <g>
                    ...
                    <polygon fill="current" points="102.420513 128.06 168.749025 89.642 102.420513 51.224"></polygon>
            </g>
    </svg>
    );
};